...
params.bamtobed="$projectDir/scripts/MakeBed.py"
params.bedtogtf="$projectDir/scripts/MakeGTF.py"
params.bam //the input bulk bam, must be sorted, read 1 antisense, paired end
...
'''
featureCounts -p -s 2 -t exon -g gene_id -a genes.gtf -o counts.txt -R BAM input.bam
'''
}
